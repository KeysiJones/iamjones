  ...
  return (
    <main className='flex flex-col border-b'>
      ...
      <div>
        ...
        {/*<div className='relative flex h-screen mr-40 justify-evenly hero-section top-36'>
          {/*<Image
        ...
        {/*<div className='max-w-[530px] font-medium ml-32 max-h-[350px] z-10'>
          <p className='text-black font-extralight text-4xl pt-20 leading-[44px]'>
          ...
          <button
            className='px-8 py-2 text-white bg-[#E92C01] rounded-lg mt-14 text-2xl hover:scale-110 transition-all'
            onClick={() =>
              window.open(
        ...
        <div className='flex items-center h-screen justify-evenly bg-[#F6F6F6]'>
          <Image
          ...
          <div className='max-w-[530px] font-medium z-10'>
            <p className='text-4xl leading-[44px] text-black'>
              ...
              <br />
              <br />
              No meu tempo livre eu me dedico a aprender sobre desenvolvimento pessoal e compartilho minhas
              experiencias no podcast Deixando a mediocridade.
            </p>
            <button
              className='px-8 py-2 text-white bg-[#1DB954] rounded-lg mt-14 text-2xl hover:scale-110 items-center transition-all'
              onClick={() =>
                window.open(
                  'https://www.youtube.com/playlist?list=PLUpxFKg0SwNkVXcPl_w1HFm8BrFTq9Mbn',
                  '_blank'
        ...
        <div className='flex items-center justify-center h-screen'>
          <div className='max-w-[530px] font-medium mr-32 max-h-[350px] z-10'>
        ...
        <div className='flex flex-col items-center bg-[#F6F6F6] p-14 justify-evenly'>
          <p className='text-5xl leading-[44px] text-black'>
            Me acompanhe nas redes sociais
          </p>
          <div className='flex justify-around w-full max-w-xs py-12'>
            <div className="hover:cursor-pointer" onClick={() => window.open("https://www.instagram.com/iamjonesfernandes/", "_blank")}>
              <svg
            ...
            <div className="hover:cursor-pointer" onClick={() => window.open("https://www.facebook.com/keysij0nes/", "_blank")}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='64'
                height='64'
            ...
            <div className="hover:cursor-pointer" onClick={() => window.open("https://twitter.com/keysi_jones", "_blank")}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='64'
                height='64'
            ...
            <div className="hover:cursor-pointer" onClick={() => window.open("https://open.spotify.com/show/7cs8g8C5J0SdHZExQyb1uI", "_blank")}>
              <svg
                width='64'
                height='64'
                xmlns='http://www.w3.org/2000/svg'
